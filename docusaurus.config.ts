...
const config: Config = {
  ...
  projectName: 'passthru', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/UmmItC/passthru/tree/master/',
      ...
      links: [
        {
          ...
          items: [
            {
              label: 'Github',
              href: 'https://github.com/UmmItC/passthru',
            },
          ],
        }
      ],
      copyright: `Copyright © ${new Date().getFullYear()} passthru, Inc. Built with Docusaurus.`,
    },
    prism: {
